...
$sourceUri = "https://asdk757288093.blob.core.windows.net/asdk/CloudBuilder.vhd"
$templateUri = "https://raw.githubusercontent.com/elysium-build/AzureStack-VM-PoC/master/ARMv2/ASDKAzureVMTemplate.json"
$sleepTimer = 60
$container = "asdk"
$saPrefix = "asdk"
